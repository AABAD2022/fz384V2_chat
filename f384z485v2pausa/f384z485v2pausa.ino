...
const int TIEMPOENTRELED = 3; //mili segundos
...
void loop() {
 ...
 Controllino_RS485RxEnable(); // activamos serial3 para recivir datos
     ...
     if (BUFF_READ[0] == STX) {      
       ...
       */
        ...
        */
          ...
          if (MODE_R == 1){ Serial3.write((uint8_t*)DATA_OUT, sizeof(DATA_OUT));
            Serial3.println("Datos transmitidos por el puerto serial3");
}
           
          if (MODE_R == 2){ SERVER.write((uint8_t*)DATA_OUT, sizeof(DATA_OUT));
            SERVER.println("Datos transmitidos por el puerto SERVER");
}
           
          if (MODE_R == 3){ Serial1.write((uint8_t*)DATA_OUT, sizeof(DATA_OUT));
          Serial3.println("Datos transmitidos por el puerto serial3");}
        }
        /*
        ...
        */
        if (BUFF_READ[1] == 0x12 ) {  //02 12 00 00 00 03 Chk
          ...
          ABRIR_CARROS();
          if (MODE_R == 1){ Serial3.write((uint8_t*)DATA_OUT, sizeof(DATA_OUT));}
          else if (MODE_R == 2){ SERVER.write((uint8_t*)DATA_OUT, sizeof(DATA_OUT));}
          else if (MODE_R == 3){ Serial1.write((uint8_t*)DATA_OUT, sizeof(DATA_OUT));
          }
        }
        /*
        ...
        */
        ...
        else if (MODE_R == 1){ Serial3.write((uint8_t*)DATA_OUT, sizeof(DATA_OUT));}
        CLEAR_DATA(TIME_);   
       }
           Serial3.flush();
